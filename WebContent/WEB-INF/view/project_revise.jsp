...
<body>
	<div id="text">
		<form action="addroute" onsubmit="" method="post">
			...
			<p>
				<label>项目名称</label>
				<input type="text" id="pnamesignup" name="pnamesignup" value="三小管理系统" required="required"/>
			</p>
			<p>
				<label>指导老师</label>
				<input type="text" id="pteasignup" name="pteasignup" value="蔡柯" required="required"/>
			</p>
			<p>
				<label>指导老师电话</label>
				<input type="text" id="pttelsignup" name="pttelsignup" value="13000000000" required="required"/>
			</p>
			<p>
				<label>项目简介</label>
				<p id="pprofilesignup" contenteditable="true">
					aiudfiudsaiuasdbivudsbaiudv</p>
			</p>
			<p>
				<label>项目计划</label>
			...
			<p>
				<label>经费需求</label>
				<input type="text" id="pfeesignup" name="pfeesignup" value="1000" pattern="^\d+(\.\d+)?$" title="请输入数字" required="required"/>
			</p>
			<p>
				<label>类型</label>
